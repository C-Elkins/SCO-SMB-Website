...
import { DocumentVolumeCalculator } from '@/components/DocumentVolumeCalculator';
import { NetworkBandwidthCalculator } from '@/components/NetworkBandwidthCalculator';
import { FileNamingGenerator } from '@/components/FileNamingGenerator';
      ...
      <section className="relative bg-linear-to-br from-[#153B6B] via-[#1e4a7f] to-[#00A8B5] text-white pt-32 pb-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            >
              Free Business <span className="text-[#00A8B5]">Tools</span>
            </motion.h1>
            ...
            >
              Calculate ROI, discover printers, and optimize your document workflow with our free tools.
            </motion.p>
        ...
        <div className="container-custom max-w-6xl">
          <div className="grid grid-cols-1 gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <NetworkBandwidthCalculator />
            </motion.div>

            {/* File Naming Pattern Generator */}
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
