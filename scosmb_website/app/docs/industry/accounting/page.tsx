...
import { Calculator, DollarSign, FileText, Shield, Clock, TrendingUp, Archive, AlertCircle, CheckCircle, Lock, Users } from 'lucide-react'
import PageHeader from '@/components/PageHeader'

export const metadata: Metadata = {
  title: 'Accounting Industry Guide - SCO SMB Documentation',
  description: 'Financial document management solutions for accounting firms with audit trail compliance, SOX requirements, and automated workflows.',
}
...
export default function AccountingIndustryPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <PageHeader
        title="<span class='text-[#00A8B5]'>Accounting</span> Industry Solutions"
        subtitle="Financial document management solutions for accounting firms with audit trail compliance, SOX requirements, and automated workflows."
        icon="Calculator"
        backLink={{
          href: "/docs",
