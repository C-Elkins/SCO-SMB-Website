            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input 
                    type="number" 
                    value={settings.portalSettings.maxDailyDownloads}
                    onChange={(e) => setSettings({...settings, portalSettings: {...settings.portalSettings, maxDailyDownloads: parseInt(e.target.value)}})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A8B5] focus:border-transparent"
                    min="1"
                  />
                  <p className="text-xs text-gray-500 mt-1">Maximum downloads allowed per day</p>
                </div>
                ...
                <div>
                  ...
                  <input 
                    type="email" 
                    value={settings.portalSettings.adminEmail}
                    onChange={(e) => setSettings({...settings, portalSettings: {...settings.portalSettings, adminEmail: e.target.value}})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A8B5] focus:border-transparent"
                  />
                  <p className="text-xs text-gray-500 mt-1">Email for system notifications and alerts</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      <label className="block text-sm font-medium text-gray-700">Enable Download Logging</label>
                      <p className="text-xs text-gray-500">Track all software downloads with detailed logs</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                        checked={settings.portalSettings.enableDownloadLogging}
                        onChange={(e) => setSettings({...settings, portalSettings: {...settings.portalSettings, enableDownloadLogging: e.target.checked}})}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#00A8B5]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#00A8B5]"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Send email alerts for key events</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                        checked={settings.portalSettings.enableEmailNotifications}
                        onChange={(e) => setSettings({...settings, portalSettings: {...settings.portalSettings, enableEmailNotifications: e.target.checked}})}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#00A8B5]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#00A8B5]"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Prevent abuse with download rate limits</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                        checked={settings.portalSettings.enableRateLimiting}
                        onChange={(e) => setSettings({...settings, portalSettings: {...settings.portalSettings, enableRateLimiting: e.target.checked}})}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#00A8B5]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#00A8B5]"></div>
                    </label>
